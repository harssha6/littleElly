...
self.addEventListener('notificationclick', function (event) {
  ...
  if (data.IsWelcomeMessage) {
      ...
      p5actionUrl = p5actionUrl.indexOf("?") > -1 ? p5actionUrl + "&p5Source=webpush&p5uniqueid="+data.responseid+"" : p5actionUrl + "?p5Source=webpush&p5uniqueid="+data.responseid;
...
function UpdateWebPushSent(ResponseData, data) {
  ...
  fetch('//pgwebpush.plumb5.com/PushNotification/UpdateWebPushSent', {
      method: 'post',
